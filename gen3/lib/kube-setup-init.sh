...
if [[ -z "$GEN3_NOPROXY" ]]; then
  ...
  export no_proxy=${no_proxy:-"localhost,127.0.0.1,169.254.169.254,.internal.io,logs.us-east-2.amazonaws.com,kibana.planx-pla.net,.eks.amazonaws.com,${KUBERNETES_SERVICE_HOST:-127.0.0.2}"}
fi
